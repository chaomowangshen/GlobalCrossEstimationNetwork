...
def run(n_person_sim,n_item_sim,n_reps,depths,batch_size,lr,epochs,early_stopping_count,sim='sim1'):
    ...
    for n_person in n_person_sim:
        for n_item in n_item_sim:
            ...
            for n_depth in depths:
                ...
                save_path_mean=f'../metrics_summary/{sim}/init/n_p_{n_person}_ni_{n_item}'
                save_path_std=f'../metrics_summary/{sim}/init/n_p_{n_person}_ni_{n_item}'
...
if __name__ == '__main__':
    ...
    run(n_person_sim,n_item_sim,n_reps,depths,batch_size,lr,epochs,early_stopping_count,sim='sim1')
